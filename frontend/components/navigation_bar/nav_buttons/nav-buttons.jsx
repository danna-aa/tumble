    ...
    const loggedInButtons = () => (
        <div className="logged-in-nav-bar-group">
            ...
            <ul className="nav-bar-icon-links">
                <li><Link to='/dashboard' className="icon" title="Dashboard"><i className="fas fa-home"></i></Link></li>
                <li><Link to='/explore' className="icon" title="Explore"><i className="far fa-compass"></i></Link></li>
                ...
                <li><Link to={`/users/${currentUser.id}`} className="icon" title="Account"><i className="fas fa-user"></i></Link></li>
