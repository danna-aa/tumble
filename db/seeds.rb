...
user2 = User.create(username: 'danna', password: 'password', email: 'danna@berkeley.edu')
user3 = User.create(username: 'boba', password: 'password', email: 'boba@aa.io')
user4 = User.create(username: 'mochi', password: 'password', email: 'mochi@aa.io')
